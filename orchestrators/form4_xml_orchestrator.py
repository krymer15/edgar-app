...
import os
from orchestrators.base.xml_orchestrator_base import XmlOrchestratorBase
from parsers.managers.filing_parser_manager import FilingParserManager
from writers.form4_writer import Form4Writer
...
class Form4XmlOrchestrator(XmlOrchestratorBase):
